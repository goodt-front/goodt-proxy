...
| -                             |                                                                                                                             |
| `/render/`                    | Пакет c переиспользуемой функциональностью рендеринга **widget** посредством механизмов `Vue.js` |
| -                             |                                                                                                                             |
...
| -                             |                                                                                                                             |
| `/Elem/`                      | Пакет Базового Компонента виджета **widget component** IElem                                                                                                   |
| `/Panel/`                     | Пакет Базовой Панели Виджета **widget panel** IPanel                                                                                                 |
| -                             |                                                                                                                             |
| `/`~ Const                    | константы                                                                                                                   |

### Публичные агрегаты пакетов и элементы
| название                      | описание                                                                                                                    |
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
